...
💳 Predicción de Churn de Clientes de Tarjeta de Crédito
...
git clone https://github.com/tu-usuario/credit-card-churn.git

Instalar dependencias:

pip install pandas numpy matplotlib seaborn plotly scikit-learn imbalanced-learn scikit-plot

Ejecutar el script:

python clientes_tarjeta_de_credito.py
